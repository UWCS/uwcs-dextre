...
chlorox = bleach.Cleaner(
        tags=["a", "abbr", "b", "bdi", "bdo", "del", "dfn", "em", "h1", "h2", "h3", "h4", "h5", "h6", "i", "img", "ins",
              "kbd", "mark", "output", "p", "picture", "pre", "q", "rp", "rt", "ruby", "s", "samp", "small", "span",
              "strong", "sub", "sup", "time", "u", "ul", "var", "wbr"],
        attributes={
            '*': ['style', 'dir', 'class', 'id', 'lang', 'tabindex', 'title', 'translate'],
            'a': ['download', 'href', 'hreflang', 'media', 'referrerpolicy', 'rel', 'target', 'type'],
            'bdo': ['dir'],
        ...
        styles=["background", "background-attachment", "background-blend-mode", "background-clip", "background-color",
                "background-image", "background-origin", "background-position", "background-repeat", "background-size",
                "box-decoration-break", "box-shadow", "caption-side", "clear", "clip", "color", "cursor", "direction",
                "display", "filter", "font", "font-family", "font-feature-settings", "font-kerning",
                ...
                "font-weight", "height", "hyphens", "image-rendering", "justify-content", "letter-spacing",
                "line-break", "line-height", "margin", "margin-bottom", "margin-left", "margin-right", "margin-top",
                ...
                "padding-right", "padding-top", "perspective", "perspective-origin", "pointer-events", "position",
                "quotes", "scroll-behavior", "tab-size", "table-layout", "text-align", "text-align-last",
                ...
                "text-shadow", "text-transform", "text-underline-position", "transform", "transform-origin",
                "transform-style", "unicode-bidi", "user-select", "vertical-align", "visibility", "white-space",
